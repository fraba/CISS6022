...
## In-Class Activity: Jurisdiction Scenario

**Scenario:** A hacker in Country A uses servers in Country B to launch ransomware attacks against hospitals in Country C.

**Discussion questions:**

1. Which country should have jurisdiction to prosecute?
2. What if all three countries want to prosecute?
3. How should conflicting claims be resolved?
4. What role should international cooperation play?

::: fragment
Share your thoughts on Padlet: [link to be provided]
:::
...
## In-Class Activity: Cyber Norms Poll

**Mentimeter questions:**

1. Do you think international norms can effectively constrain state cyber operations?
   - Yes, norms matter even without enforcement
   - No, states will do what serves their interests
   - Unsure

2. What is the biggest obstacle to effective cyber norms?
   - Attribution challenges
   - Conflicting state interests
   - Rapid technological change
   - Verification difficulties

Vote at: [Mentimeter link to be provided]
