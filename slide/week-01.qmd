...
5. Modern Systems & Incident Response
6. Secure System Design Principles
:::
::: {.column width="50%"}
...
- Anything beyond 10 minutes will not be marked — practice and/or use [Clipchamp](https://clipchamp.com/en/video-editor/) or another video editing software)!

---

## Assessments 2, 3 & 4

**Crisis Simulation (5%) — Week 8, 22 or 23 April**
...
2-hour pen-and-paper exam: 60 multiple choice questions (30 technical, 30 arts/policy) ~~+ 2 short-answer questions (5 points each)~~. AI prohibited. (Note: There will be no short-answer questions in the exam.)
